...
# HEADER
# =========================================
st.markdown("<h1 style='text-align:center;'>💳 Loan Approval AI System</h1>", unsafe_allow_html=True)
st.markdown("<p style='text-align:center;'>Smart Credit Risk Evaluation</p>", unsafe_allow_html=True)
